...
#define  TAB_AUTO_LED_MC_8                52      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_LED_MC_7                53      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_LED_MC_6                54      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_LED_MC_5                55      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_LED_MC_4                56      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_LED_MC_3                57      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_LED_MC_2                58      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_LED_MC_1                59      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_IF_TXT_8                60      /* control type: textMsg, callback function: (none) */
#define  TAB_AUTO_IF_TXT_7                61      /* control type: textMsg, callback function: (none) */
#define  TAB_AUTO_IF_TXT_6                62      /* control type: textMsg, callback function: (none) */
#define  TAB_AUTO_IF_TXT_5                63      /* control type: textMsg, callback function: (none) */
#define  TAB_AUTO_LED_IF_8_M              64      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_LED_IF_7_M              65      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_LED_IF_8_P              66      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_LED_IF_7_P              67      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_IF_TXT_4                68      /* control type: textMsg, callback function: (none) */
#define  TAB_AUTO_LED_IF_6_M              69      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_LED_IF_6_P              70      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_LED_IF_5_M              71      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_LED_IF_5_P              72      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_IF_TXT_3                73      /* control type: textMsg, callback function: (none) */
#define  TAB_AUTO_LED_IF_4_M              74      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_LED_IF_4_P              75      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_IF_TXT_2                76      /* control type: textMsg, callback function: (none) */
#define  TAB_AUTO_LED_IF_3_M              77      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_LED_IF_3_P              78      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_IF_TXT_1                79      /* control type: textMsg, callback function: (none) */
#define  TAB_AUTO_LED_IF_2_M              80      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_LED_IF_2_P              81      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_LED_IF_1_M              82      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_LED_IF_1_P              83      /* control type: LED, callback function: (none) */
#define  TAB_AUTO_SPLITTER_6              84      /* control type: splitter, callback function: (none) */
#define  TAB_AUTO_SPLITTER_8              85      /* control type: splitter, callback function: (none) */
#define  TAB_AUTO_SPLITTER_5              86      /* control type: splitter, callback function: (none) */
#define  TAB_AUTO_SPLITTER_4              87      /* control type: splitter, callback function: (none) */
#define  TAB_AUTO_SPLITTER_3              88      /* control type: splitter, callback function: (none) */
#define  TAB_AUTO_SPLITTER_2              89      /* control type: splitter, callback function: (none) */
#define  TAB_AUTO_SPLITTER                90      /* control type: splitter, callback function: (none) */
