...
<distribution version="20.0.0" name="Main" type="MSI">
	...
	<msi GUID="{C72AFB54-CC38-47BC-AA9C-AF022F6EE5E3}">
		<general appName="Main" outputLocation="e:\@PROJECT\LAON\CVI\CVI2020\JTC\cvidistkit.Main" relOutputLocation="cvidistkit.Main" outputLocationWithVars="e:\@PROJECT\LAON\CVI\CVI2020\JTC\cvidistkit.%name" relOutputLocationWithVars="cvidistkit.%name" upgradeBehavior="1" autoIncrement="true" version="1.0.7">
		...
		<dirs appDirID="100">
			<installDir name="Main" dirID="100" parentID="2" isMSIDir="false" visible="true" unlock="false"/>
			<installDir name="Main" dirID="101" parentID="7" isMSIDir="false" visible="true" unlock="false"/>
			<installDir name="[Start&gt;&gt;Programs]" dirID="7" parentID="-1" isMSIDir="true" visible="true" unlock="false"/>
			<installDir name="[Program Files]" dirID="2" parentID="-1" isMSIDir="true" visible="true" unlock="false"/></dirs>
		<files>
			<simpleFile fileID="0" sourcePath="e:\@PROJECT\LAON\CVI\CVI2020\JTC\cvibuild.Main\Release\Main.exe" targetDir="100" readonly="false" hidden="false" system="false" regActiveX="false" runAfterInstallStyle="IMMEDIATELY_RESUME_INSTALL" cmdLineArgs="" runAfterInstall="false" uninstCmdLnArgs="" runUninst="false"/></files>
		<fileGroups>
		...
		<shortcuts>
			<shortcut name="Main" targetFileID="0" destDirID="101" cmdLineArgs="" description="" runStyle="NORMAL"/></shortcuts>
		<mergemodules/>
		<products/>
		...
		<Projects NumProjects="1">
			<Project000 ProjectID="0" ProjectAbsolutePath="e:\@PROJECT\LAON\CVI\CVI2020\JTC\Main.prj" ProjectRelativePath="Main.prj"/></Projects>
		<buildData progressBarRate="5.453893617420563">
			<progressTimes>
				<Begin>0.000000000000000</Begin>
				<ProductsAdded>0.326634968750020</ProductsAdded>
				<DPConfigured>0.968067757812521</DPConfigured>
				<DPMergeModulesAdded>1.198352023437514</DPMergeModulesAdded>
				<DPClosed>1.627569890625017</DPClosed>
				<DistributionsCopied>2.086103835937523</DistributionsCopied>
				<End>18.335524492187531</End></progressTimes></buildData>
	</msi>
</distribution>
